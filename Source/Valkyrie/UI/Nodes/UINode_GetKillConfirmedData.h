...
UCLASS()
class VALKYRIE_API UUINode_GetKillConfirmedData : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()

public:
	UFUNCTION(BlueprintCallable, Category="Valkyrie")
	static FValkKillConfirmedData GetKillConfirmedData(APlayerController* aPlayerController);
};
